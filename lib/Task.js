...
class Task {
  constructor(genfn, token) {
      ...
      if (
        typeof genfn[Symbol.iterator] !== 'function' ||
        typeof genfn.return !== 'function' ||
        typeof genfn.throw !== 'function' ||
        typeof genfn.next !== 'function') {
        throw new Error('Expected a generator function or generator instance');
      }
